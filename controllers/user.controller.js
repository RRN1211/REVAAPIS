                                ...
                                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0 auto; padding: 0; width: 570px;" bgcolor="#FFFFFF"> 
                                  ...
                                  <tr> 
                                    <td class="content-cell" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding: 35px; word-break: break-word;"> 
                                      <h1 style="box-sizing: border-box; color: #2F3133; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;padding: 10px;background-color: #577F9B; color:white;text-align: center;" align="left">BIENVENIDO</h1> 
                                      <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;padding: 10px;background-color: #577F9B; color:white;text-align: center;" align="left">DA CLICK EN EL ENLACE PARA ACTIVAR TU CUENTA</p> 
                                       
                                      <div style="border: 1px solid #505050;">
                                      http://104.248.94.77/api/v1/usuarios/activar/${data._id}
                                      </div>
